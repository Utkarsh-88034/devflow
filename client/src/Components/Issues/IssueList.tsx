...
import { GET_ISSUE_BY_ID } from "../../Queries/dashboardQueries";
...
const IssueList = () => {
  const { loading, error, data } = useQuery(GET_ISSUE_BY_ID, {
    variables: { id: "64cf3552363ea00ac498f349" },
  });
  ...
  console.log(JSON.parse(issue.environment));
  return (
    <div className="h-screen flex-grow  flex flex-col items-center p-5 overflow-scroll ">
