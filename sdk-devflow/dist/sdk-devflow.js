...
var DevFlow = /*#__PURE__*/function () {
  ...
  _proto.generateIssueDetails = function generateIssueDetails(error, data, type) {
    ...
    var sendInfo = function sendInfo() {
      try {
        graphqlRequest.request(api, query, variables);
...
var DevFlowContext = React__default.createContext(undefined);
var DevFlowProvider = function DevFlowProvider(_ref) {
  ...
  return React__default.createElement(DevFlowContext.Provider, {
    value: contextValue
  }, children);
};

var useDevFlow = function useDevFlow() {
  var context = React.useContext(DevFlowContext);
  if (!context) {
...
exports.DevFlowProvider = DevFlowProvider;
exports.useDevFlow = useDevFlow;
//# sourceMappingURL=sdk-devflow.js.map
